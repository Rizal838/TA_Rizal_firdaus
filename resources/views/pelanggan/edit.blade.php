...
route('pelanggan.update', $data->Id_pelanggan) }}">
@csrf
 <div class="mb-3">
 <label for="id_pelanggan" class="form-label">ID Pelanggan</label>
 <input type="text" class="form-control" 
id="Id_pelanggan" name="Id_pelanggan" value="{{ $data->Id_pelanggan }}">
 </div>
<div class="mb-3">
 <label for="Nama_pelanggan" class="form-label">Nama pelanggan</label>
 <input type="text" class="form-control" 
id="Nama_pelanggan" name="Nama_pelanggan" value="{{ $data->Nama_pelanggan}}">
 </div>
 <div class="mb-3">
