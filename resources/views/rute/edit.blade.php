...
route('rute.update', $data->Id_rute) }}">
@csrf
 <div class="mb-3">
 <label for="id_rute" class="form-label">ID rute</label>
 <input type="text" class="form-control" 
id="Id_rute" name="Id_rute" value="{{ $data->Id_rute }}">
 </div>
<div class="mb-3">
 <label for="Kota_asal" class="form-label">Kota_asal</label>
 <input type="text" class="form-control" id="Kota_asal" name="Kota_asal" value="{{ $data->Kota_asal}}">
 </div>
 <div class="mb-3">
