...
@section('content')
<h4 class="mt-5">Data maskapai</h4>
<a href="{{ route('maskapai.create') }}" type="button" 
...
<table class="table table-hover mt-2">
 ...
 <td>
 <a href="{{ route('maskapai.edit', $data->Id_maskapai) }}" type="button" class="btn btn-warning rounded-3">Ubah</a>
...
id="hapusModal{{ $data->Id_maskapai }}" tabindex="-1" 
...
<form method="POST" 
action="{{ route('maskapai.delete', $data->Id_maskapai) }}">
 @csrf
